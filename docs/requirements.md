...
- [ ] Recursive algorithms (might have already done this)
...
- [x] Cohesive modules (subroutines) – module code does just one thing.
- [x] Modules(collections of subroutines) – subroutines with common purpose grouped.
- [ ] Defensive programming.
- [ ] Good exception handling.
- [ ] Well-designed user interface (hardest one here)
